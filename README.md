...
I build full-stack apps with React, Node.js, FastAPI, MongoDB and PostgreSQL, and most of my time goes into the backend: auth, multi-tenant data isolation, rate limiting, transactions and indexing. On the ML side I've trained models that predict road closures across Bengaluru and recommend Hindi poetry.
Currently doing undergraduate research on adaptive recommendation systems at BIT Mesra.
...
3. **[Namma AI](https://github.com/saminadamn/namma-traffic)**: Traffic intelligence platform for Bengaluru, built with team ML Baddies for Flipkart Gridlock 2.0. A CatBoost stacked ensemble predicts road closures and incident priority (**ROC-AUC 0.81 / 0.82**), kept leakage-free with out-of-fold spatial features and geohash holdout validation. DBSCAN picks out hotspots from live incident data, and an A* engine on OSMnx road graphs routes traffic around active incidents. [Live demo](https://namma-traffic-virid.vercel.app/)
4. **[DhanSetu](https://github.com/Madhurtandon1/dhansetu2)**: Loan eligibility platform for NBCFDC schemes, built for Smart India Hackathon 2025, where we were Grand Finalists. A KNN model sorts applicants into risk bands so officers can assess people with very little paperwork. React, Node/Express, MongoDB.
5. **[Urban Retail Inventory Analytics](https://github.com/Madhurtandon1/solving_inventory_Inefficiencies-using-Advanced-SQL-Analytics_2)**: SQL case study from an IIT Guwahati challenge. Stored procedures take 109,500 rows of raw inventory data (30 products, 5 stores) through bronze and silver layers into 7 relational tables, with ROW_NUMBER() CTEs clearing out duplicate product IDs on the way. Reorder points use average daily sales over the last 30 days against a 7-day lead time, and turnover and stockout-rate queries feed a Power BI operations dashboard.
6. **[Amazon India Sales Analysis](https://github.com/Madhurtandon1/Amazon_data_analysis)**: Cleaning and EDA on 121K Amazon India fashion orders from April to June 2022 in Pandas, Seaborn and SciPy, finished as a 4-page Power BI dashboard. Sets brought in half the revenue at the highest average order value (₹833), and Maharashtra and Karnataka together placed 47% of all orders.
...
## Activity
[![Madhur's contribution graph](https://github-readme-activity-graph.vercel.app/graph?username=Madhurtandon1&theme=github-light&hide_border=true&hide_title=true&area=true)](https://github.com/Madhurtandon1)
